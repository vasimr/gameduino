...
## Pmod header JA
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports SCK]
...
set_property -dict {PACKAGE_PIN AB18 IOSTANDARD LVCMOS33} [get_ports SSEL]
set_property -dict {PACKAGE_PIN Y21 IOSTANDARD LVCMOS33} [get_ports AUDIOL]
#set_property -dict { PACKAGE_PIN AA21  IOSTANDARD LVCMOS33 } [get_ports { ja[5] }]; #IO_L8N_T1_D12_14 Sch=ja[8]
set_property -dict {PACKAGE_PIN AA20 IOSTANDARD LVCMOS33} [get_ports AUDIOR]
...
set_property -dict {PACKAGE_PIN R6 IOSTANDARD LVCMOS33} [get_ports vga_hsync_n]
set_property -dict {PACKAGE_PIN T6 IOSTANDARD LVCMOS33} [get_ports vga_vsync_n]
...
create_clock -period 20.000 -name main_clk -waveform {0.000 10.000} -add [get_nets vga_clk]
